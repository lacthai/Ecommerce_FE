    ...
    <Container>
      <div className="about-us_header">
        <div className="about-us_header-icon">
          <img src={flower1} alt="icon1" />
        </div>
        <div className="about-us_header-title">
          <p>
            Make Your Life Look <span>More Modern</span>
          </p>
        </div>
        <div className="about-us_header-icon">
          <img src={flower2} alt="icon2" />
        </div>
      </div>
      <div className="about-us_body">
        ...
        <img src={banner1} alt="" className="banner2" />
        <img src={banner1} alt="" className="banner3" />
        <img src={banner1} alt="" className="banner4" />
        <img src={banner1} alt="" className="banner5" />
        <img src={banner1} alt="" className="banner6" />
        <img src={banner1} alt="" className="banner7" />
