...
function ProductPage() {
    ...
    const images = product.pictures.map((picture) => <img className="product__carousel--image" src={picture.url} onDragStart={handleDragStart} alt="img_carousel"/>);
        ...
        <Container className="pt-4" style={{ position: "relative" }}>
            <Row>
                <div className="product_page-index">
                    <ul>
                        <Link to="/" style={{textDecoration: "none", color: "#f0c35c"}}><li>Home</li></Link>
                        <li><BiArrowFromLeft style={{color: "#989898"}}/></li>
                        <Link to="/category/all" style={{textDecoration: "none", color: "#f0c35c"}}><li>Product</li></Link>
                        <li><BiArrowFromLeft style={{color: "#989898"}}/></li>
                        <Link to="/category/laptops" style={{textDecoration: "none", color: "#f0c35c"}}><li>{product.category}</li></Link>
                    </ul>
                </div>
                <Col lg={5}>
                ...
                <Col lg={6} className="pt-4">
                    ...
                    <p className="product__price" style={{fontSize: "2rem"}}>${product.price}</p>
                    {user && !user.isAdmin && (
